...
public class SubmitApplicationUI extends javax.swing.JFrame {
    ...
    private static final long serialVersionUID = -8987241503863659671L;

    /**
     * Creates new form SubmitApplicationUI
     */
    public SubmitApplicationUI() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SubmitApplicationUI.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new SubmitApplicationUI().setVisible(true);
            }
        });
    }
